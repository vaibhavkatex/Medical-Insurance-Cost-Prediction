...
The objective of this project is to build regression models that can accurately predict insurance charges based on features such as:
...
```bash
git clone https://github.com/vaibhavkatex/Medical-Insurance-Cost-Prediction.git
```
